...
public class MultiThreadingUtilTest {
    ...
    public void testSplitDatasetIntoRanges() {
        ...
        List<DatasetRange> datasetRangeList = MultiThreadingUtil
            .splitDatasetIntoRanges(dataset, 3);
        ...
        List<DatasetRange> datasetRangeList2 = MultiThreadingUtil
            .splitDatasetIntoRanges(dataset2, 4);
